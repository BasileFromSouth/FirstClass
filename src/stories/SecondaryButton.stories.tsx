...
function SecondaryButtonCodeConnectExample({
  children,
  size,
  shape,
  disabled,
...
const meta = {
  ...
  parameters: {
    ...
    design: {
      type: 'figma',
      url: 'https://www.figma.com/design/OslApqcneRIMzWSg0lWSUI/Stoodio?node-id=55-434',
      examples: [SecondaryButtonCodeConnectExample],
      links: [
        {
          name: 'Storybook',
          url: 'http://localhost:6006/?path=/docs/components-button-secondary--docs',
        },
      ],
      props: {
